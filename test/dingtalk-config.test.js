...
describe('normalizeDingTalk', () => {
  it('coerces types and trims', () => {
    ...
    assert.deepEqual(n, { enabled: true, appKey: 'key', appSecret: 'sec', allowStaffIds: ['a', 'b'], maxChunkChars: 4000, blockOnSkipPermissions: false });
  });
...
describe('save / load roundtrip', () => {
  ...
  it('roundtrips through preferences.json (plaintext in memory, base64 on disk)', () => {
    ...
    assert.deepEqual(loadDingTalkConfig(), { enabled: true, appKey: 'ding123', appSecret: 'topsecret', allowStaffIds: ['u1'], maxChunkChars: 2000, blockOnSkipPermissions: false });
